...
/**
 ...
 @Override protected void setContext(Context context) {
 ...
 @Override public void failed(String prompt) {
 _activity.setRefreshAnimation(false);
 ...
 @Override public void start(String prompt) {
 ...
 @Override public void showProgress(int progress) {
