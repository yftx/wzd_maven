...
public class Preferences {
    ...
    public static final String AUTO_CHECK_UPDATES_KEY = "auto_check_update";
    ...
    public static final String BASE_BID_APR_KEY = "base_bid_apr";
    public static final String UI_FONT_SIZE_KEY = "ui_font_size";
    public static final String USE_SHAKE_KEY = "use_shake";
    public static final String SORT_BID_KEY = "sort_bid";
